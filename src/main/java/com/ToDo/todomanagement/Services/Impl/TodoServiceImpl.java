...
import com.ToDo.todomanagement.Exceptions.ResourceNotFoundException;
import com.ToDo.todomanagement.Models.Todo;
import com.ToDo.todomanagement.Repositories.TodoRepository;
...
//        List<TodoDto> todoDtos = todos.stream().map((todo) -> modelMapper.map(todo, TodoDto.class));
    ...
    public TodoDto updateTodo(TodoDto todoDto, Long id) {
        ...
        todo.setDescription(todoDto.getDescription());
        todo.setCompleted(todoDto.isCompleted());
        Todo updatedTodoDto = todoRepository.save(todo);
        return modelMapper.map(updatedTodoDto, TodoDto.class);
    }
